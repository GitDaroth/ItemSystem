...
namespace ItemSystem
{
    ...
    *  @brief Responsible for creating/instantiating ItemEffects and ItemEffectTemplates
    */
    ...
    public:
        ...
        /**
        *  @brief Registers a concrete ItemEffect and concrete ItemEffectTemplate class with a type tag referencing the ItemEffect in the JSON-File
        */
